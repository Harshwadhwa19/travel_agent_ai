  ...
  return (
    ...
    >
      ...
      <Box
        ...
        alignItems="center"
      >
        <Link fontSize="md">Find travel Buddy</Link>
      ...
      <Box
        ...
        alignItems="center"
      >
       <Link fontSize="md" to={"/things"} >Things to Do</Link>
        ...
        <Menu w="100%">
          ...
          <Portal>
            <MenuList color="black" w="80%" m="auto" ml="-15%">
              <MenuItem mt="10px" fontWeight="500" fontSize="17px">
              ...
              <MenuItem mt="10px" fontWeight="500" fontSize="17px">
                <Link>Package Holidays</Link>
              </MenuItem>
              <MenuItem mt="10px" fontWeight="500" fontSize="17px">
                <Link>Travel Forums</Link>
              </MenuItem>
              <MenuItem mt="10px" fontWeight="500" fontSize="17px">
                <Link>Travellers' Choice</Link>
              </MenuItem>
            </MenuList>
          </Portal>
        </Menu>
